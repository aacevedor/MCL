...
/**
 * Provides a 'GenerateMclVoteFormBlock' block.
 *
 * @Block(
 *  id = "generate_mcl_vote_form_block",
 *  admin_label = @Translation("Generate Mcl Vote Form Block"),
 * )
 */
class GenerateMclVoteFormBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    $form = \Drupal::formBuilder()->getForm('Drupal\mcl_votes\Form\GenerateMclVoteForm');
