...
http://foundation.zurb.com/docs/faq.php or use the script in the miss_canada_latina
...
----------------------
 ...
 1. Setup the location for your new sub-theme.
    ...
    Copy the miss_canada_latina folder out of the zurb_foundation/ folder and rename it to
    ...
    For example, copy the themes/zurb_foundation/miss_canada_latina folder and
 ...
 2. Setup the basic information for your sub-theme.
    ...
    In your new sub-theme folder, rename the miss_canada_latina.info.yml.txt file to include
    the name of your new sub-theme and remove the ".txt" extension. Then edit
    the .info file by editing the name and description field.

    For example, rename the foo/miss_canada_latina.info.yml.txt file to foo/foo.info.yml. Edit the
    foo.info.yml file and change "name: Foundation Sub-theme miss_canada_latina" to
 ...
 3. Edit your sub-theme to use the proper function names.
    ...
    First, rename miss_canada_latina.theme to include the name of your new sub-theme. In this
    example we'll assume that it's renamed foo.theme.

    Edit the foo.theme and theme-settings.php files in your sub-theme's
    folder; replace ALL occurrences of "miss_canada_latina" with the name of your
    sub-theme.

    For example, edit foo/foo.theme and foo/theme-settings.php and replace
    every occurrence of "miss_canada_latina" with "foo".
...
Optional steps:
 ...
 9. Add custom css and js files to your sub-theme
    ...
    Rename miss_canada_latina.libraries.yml to the name of your sub-theme, un-commenting
